...
You know, if not, then okay, man. Another problem was that a *lot* of the revenue columns are set to 0 (which I think probably should have been NAs). I wonder if we can find any interesting correlations at all. How about release date? What about just knowing about movies from the 2010s?
